  ...
  return (
    <header className="absolute top-0 left-0 w-full z-20 bg-transparent">
      <nav className="flex justify-between items-center p-4 font-serif">
        ...
        <div className="flex items-center space-x-5 p-7 ">
          <Link href="#">
            <Image src={Search} alt="Search" className="sm:w-2 sm:h-2 lg:w-6 lg:h-6 md:w-4 md:h-4 cursor-pointer" />
          </Link>
          <Link href="#">
            <Image src={User} alt="User" className="sm:w-2 sm:h-2 lg:w-6 lg:h-6 md:w-4 md:h-4 cursor-pointer" />
          </Link>
          <Link href="#">
            <Image src={Cart} alt="Cart" className="sm:w-2 sm:h-2 lg:w-6 lg:h-6 md:w-4 md:h-4 cursor-pointer" />
          </Link>
        </div>
