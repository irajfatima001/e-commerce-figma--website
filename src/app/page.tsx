...
import Lounge from "/public/pack.jpg";
...
export default function Home() {
  ...
  return (
    <div className="bg-zinc-200">
      <Header />
      <div className="relative w-full h-screen  overflow-hidden bg-contain ">
        <Image
          src={BackgroundImage}
          alt="Background Image"
          layout="fill"
          objectFit=""
          className="absolute top-0 left-0 z-0 rounded-b-[20px]  sm:rounded-b-[10px] md:rounded-b-[15px] lg:rounded-b-[20px] "
        />

        <div className="absolute inset-0 z-10 flex flex-col justify-center items-start h-full p-4 ml-10 bg-opacity-0 bg-silver-700 ">
          <h1 className="text-3xl md:text-5xl sm:text-xl font-serif mb-4 text-left text-emerald-900">
            Exclusive Deals of
            <br /> Furniture Collection
          </h1>
          <p className="text-lg md:text-xl sm:text-sm mb-6 text-left text-emerald-900 font-serif mt-5">
  ...
  <form onSubmit={handleSearchSubmit} className="relative mb-4">
    ...
    <input
      ...
      placeholder="Search "
      className="border border-gray-300 pl-10 pr-4 py-2 rounded-lg w-auto"
    />
  </form>
  ...
  <Link href="/categories">
    <button
      ...
      hover:bg-emerald-900 hover:shadow-xl hover:scale-105 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-75 
      active:scale-95 active:ring-0 hover:shadow-emerald-700/50 w-auto "
    >
      All Categories ---
    </button>
  </Link>
      ...
      <div className="relative py-5 bg-cover bg-center">
        <div className="relative">
          {/* <div><Image src="/canva.png" alt="products" width={300} height={300} className=" w-full h-full " /></div> */}
      ...
      <div className="flex flex-col md:flex-row p-6 bg-gray-100 rounded-lg shadow-lg">
        ...
        <div className="md:w-1/2 pl-10 ">
          ...
          />
          <h3 className="flex items-center text-xl font-semibold text-emerald-900 mt-3">
  <span className="mr-20">{specialPackage.name}</span> 
  <span>
    <button className="flex items-center bg-teal-500 text-white text-sm md:w-auto rounded-md px-3 py-3 hover:bg-teal-600 transition">
      
      Add to Cart <FaShoppingCart className="mr-2 ml-2 text-xl" />
    </button>
  </span>
</h3>
        ...
        <section className="flex flex-col md:flex-row  items-center m-10 ">
          ...
          <div className="flex-1 ">
            <Image
              ...
              width={400}
              height={400}
              className="rounded-lg h-100 w-100 m-auto"
            />
          </div>
